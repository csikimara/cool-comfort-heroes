...
// Fisher Navy Blue solution tab. Positioned 15px below the Fujitsu floating bar.
...
const FisherFloatingButton = () => {
  return (
    <Link
      ...
      aria-label="Fisher klímamegoldások oldala"
    >
      <div
        ...
        style={{ background: "linear-gradient(90deg, #1f3d66 0%, #0077bd 100%)" }}
      >
        ...
        <div className="hidden sm:block max-w-0 group-hover:max-w-xs overflow-hidden transition-all duration-300 ease-out">
          <div className="px-4 py-3 whitespace-nowrap">
            ...
            <p className="text-xs text-white">Akár 6 év</p>
          </div>
        </div>
      </div>
    </Link>
